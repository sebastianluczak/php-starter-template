...
# Versions of docker images. Bump them on each infra change.
PHP_FPM_VERSION = "1.3"
NGINX_VERSION = "1.1"
...
checks: ## Fires all code tests and checks
	...
	@echo "\033[1;32m🍺 Running Unit Tests on codebase.\033[0m"
	@$(EXEC_ON_PHP) $(cpest)
...
fix: ## Runs linter against ./src and ./tests
	...
	@echo "\033[1;32m🍺 Running PHP Code Style check on codebase.\033[0m"
